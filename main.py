...
from sigmaflow.worker_fixed.tasks import run_pipeline, run_scheduled_pipelines
from sigmaflow.worker_fixed.celery_app import celery_app
...
from sigmaflow.api.openapi_config import setup_openapi
...
# Configure custom OpenAPI documentation after all routes are registered
setup_openapi(app)
